...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 text-white py-12 sm:py-16 w-full overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">Supermarket Careers Kenya</span>
            </div>
            <p className="text-gray-400 mb-4">
              Connecting job seekers with supermarket opportunities across Kenya.
            </p>
            <p className="text-xs text-gray-500 italic mb-4">
              This is an independent recruitment service not affiliated with Quickmart Supermarket.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+254105575260</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400 mb-2">
            © 2026 Supermarket Careers Kenya. All rights reserved.
          </p>
