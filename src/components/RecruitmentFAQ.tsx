  ...
  const faqs = [
    {
      ...
      answer: "You can apply directly through our official recruitment portal at quickmartjobs.site. Simply select your preferred position, click 'Apply Now', and fill out the 5-minute application form."
    },
    {
