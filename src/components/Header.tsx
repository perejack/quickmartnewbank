        ...
        <div className="flex justify-between items-center min-h-[3.5rem] sm:min-h-[4rem]">
          ...
          <div className="flex items-center flex-shrink-0">
            <div className="flex items-center">
              ...
              <span className="ml-2 sm:ml-3 text-lg sm:text-xl md:text-2xl font-black text-red-600 whitespace-nowrap">Supermarket Careers Kenya</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              aria-label="Apply for Supermarket Jobs"
            >
              Apply Now
            </button>
          </div>
